  ...
  <section>
    <div class="container">
        ...
        <div class="mb-3 col-3">
            ...
            <div class="input-group">
                <input type="text" class="form-control" id="author" aria-describedby="basic-addon3 basic-addon4" name='author'>
            </div>
        </div>
        <div class="mb-3 col-3">
            <label for="pencils" class="form-label">Pencils</label>
            <div class="input-group">
                <input type="text" class="form-control" id="pencils" aria-describedby="basic-addon3 basic-addon4" name='pencils'>
            </div>
        </div>
        <div class="mb-3 col-3">
            <label for="inks" class="form-label">Inks</label>
            <div class="input-group">
                <input type="text" class="form-control" id="inks" aria-describedby="basic-addon3 basic-addon4" name='inks'>
            </div>
        </div>
        <div class="mb-3 col-3">
            <label for="cover_by" class="form-label">Cover By</label>
            <div class="input-group">
                <input type="text" class="form-control" id="cover_by" aria-describedby="basic-addon3 basic-addon4" name='cover_by'>
            </div>
        </div>
        <div class="mb-3 col-3">
